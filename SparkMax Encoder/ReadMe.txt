...
**Key Features**
* Firmware v24+ Compatibility: Specifically decodes the 0x2E0 (Status 0) and 0x2E2 (Status 2) frames used in recent firmware versions. [cite: 53, 55]
* High-Resolution Feedback: Decodes 32-bit IEEE floating-point values for Motor Velocity (RPM) and Position (Rotations). [cite: 53, 55]
* Electrical Diagnostics: Parses 12-bit fixed-point data to provide live readings for Bus Voltage and Phase Current. [cite: 53]
...
* Periodic Status Frames 0 and 2 must be enabled/configured on the SPARK MAX via the REV Hardware Client. [cite: 41, 47]
